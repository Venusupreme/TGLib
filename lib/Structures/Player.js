...
class Player {
    constructor(name, engine) {
         ...
         this.roleAttrs =  {attack: 0, defense: 0};
    }
    ...
    setAction(target, others = {factionalAction: undefined, visits: true}) {
    ...
    setRole(role) {
        ...
        this.role = role;
        if (role.roleAttrs) {
            for (let key in role.roleAttrs) {
                this.roleAttrs[key] = role.roleAttrs[key];
            }
        }
